...
export const metadata: Metadata = {
  ...
  description: "See our live work - web apps, mobile apps, and smart products. Every project here is running in production with real users and payments.",
    ...
    <div className="section pt-32 relative overflow-hidden isolate">
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6 relative z-10">
        <div className="text-center mb-12 sm:mb-16">
          <p className="text-base font-semibold uppercase tracking-[0.2em] text-violet-400 mb-4">Portfolio</p>
