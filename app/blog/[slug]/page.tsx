  ...
  return (
    <div className="section pt-32">
      ...
      <div className="max-w-3xl mx-auto px-6">
        <Link href="/blog" className="inline-flex items-center gap-2 text-base text-text-subtle hover:text-violet-400 transition-colors mb-8">
        ...
        <div
          className="prose prose-invert prose-base max-w-none
            [&_h2]:font-heading [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:mt-10 [&_h2]:mb-4 [&_h2]:text-text-primary
            [&_h3]:font-heading [&_h3]:text-lg [&_h3]:font-bold [&_h3]:mt-6 [&_h3]:mb-2 [&_h3]:text-text-primary
            [&_p]:text-text-muted [&_p]:leading-relaxed [&_p]:mb-4 [&_p]:text-base
            [&_strong]:text-text-primary
            [&_ul]:space-y-1.5 [&_li]:text-text-muted [&_li]:text-base
            [&_ol]:space-y-1.5
            [&_a]:text-violet-400 [&_a:hover]:underline
            [&_code]:text-cyan-400 [&_code]:text-sm [&_code]:bg-surface-elevated [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded
          "
