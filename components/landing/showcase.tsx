...
const showcase = [
  ...
  },
  {
    ...
    description: "Intelligent wedding planning with smart vendor recommendations, budget tracking, timeline management, and a beautiful website builder. Stripe subscriptions + SEO blog.",
